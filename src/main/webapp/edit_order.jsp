					...
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
								第一步：修改订单信息（加<span style="color:red"> * </span>表示必填）
							</a>
						</h4>
					</div>
						...
						<form name="order" class="form-horizontal" action="" method="post">
							<fieldset>
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="orderId" name="orderId" type="text" placeholder="" class="form-control" value="<%=order.getOrderId()%>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="customerName" name="customerName" type="text" placeholder="" class="form-control" value="<%=order.getCustomerName()%>">
									</div>
									<label class="col-md-2 control-label" for="customerTel">客户座机</label>
									<div class="col-md-4">
										<input id="customerTel" name="customerTel" type="text" placeholder="" class="form-control" value="<%=order.getCustomerTel()%>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="customerPhone">客户手机</label>
									<div class="col-md-4">
										<input id="customerPhone" name="customerPhone" type="text" placeholder="" class="form-control" value="<%=order.getCustomerPhone()%>">
									</div>
									<label class="col-md-2 control-label" for="orderDate"><span style="color:red">* </span>订货日期</label>
									<div class="col-md-4">
										<input id="orderDate" name="orderDate" type="date" placeholder="" class="form-control" value="<%=order.getOrderDate()%>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="planDeliveryDate">预计交货日期</label>
									<div class="col-md-4">
										<input id="planDeliveryDate" name="planDeliveryDate" type="date" placeholder="" class="form-control" value="<%=order.getPlanDeliveryDate()%>">
									</div>
									<label class="col-md-2 control-label" for="actualDeliveryDate"><span style="color:red">* </span>实际交货日期</label>
									<div class="col-md-4">
										<input id="actualDeliveryDate" name="actualDeliveryDate" type="date" placeholder="" class="form-control" value="<%=order.getActualDeliveryDate()%>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="deposit">预付定金</label>
									<div class="col-md-4">
										<input id="deposit" name="deposit" type="text" placeholder="" class="form-control" value="<%=order.getDeposit()%>">
									</div>
									<label class="col-md-2 control-label" for="carriage">运 费</label>
									<div class="col-md-4">
										<input id="carriage" name="carriage" type="text" placeholder="" class="form-control" value="<%=order.getCarriage()%>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="incidentals">杂 费</label>
									<div class="col-md-4">
										<input id="incidentals" name="incidentals" type="text" placeholder="" class="form-control" value="<%=order.getIncidentals()%>">
									</div>
									<label class="col-md-2 control-label" for="kickback">返 点</label>
									<div class="col-md-4">
										<input id="kickback" name="kickback" type="text" placeholder="" class="form-control" value="<%=order.getKickback()%>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="shipAddress"><span style="color:red">* </span>送货地址</label>
									<div class="col-md-10">
										<input id="shipAddress" name="shipAddress" type="text" placeholder="" class="form-control" value="<%=order.getShipAddress()%>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="commonts">备 注</label>
									<div class="col-md-10">
										<input id="commonts" name="commonts" type="text" placeholder="" class="form-control" value="<%=order.getCommonts()%>"></input>
									</div>
								</div>
								<div class="form-group">
									...
									<label class="col-md-2 control-label" for="save_order"></label>
									<div class="col-md-4">
