...
<body>
	...
	<%
		...
		String picture = "0";  // 获取到的图片无法传递到修改产品接口，所以特殊处理：传递0表示不改变图片。 
						...
						<form id="product" name="product" class="form-horizontal" action="" method="post">
							<fieldset>
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="model" name="model" type="text" placeholder="" class="form-control" value="<%=product.getModel()%>">
									</div>
									<label class="col-md-2 control-label" for="customerTel"><span style="color:red">* </span>名称</label>
									<div class="col-md-4">
										<input id="name" name="name" type="text" placeholder="" class="form-control" value="<%=product.getName()%>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="color">颜色</label>
									<div class="col-md-4">
										<input id="color" name="color" type="text" placeholder="" class="form-control" value="<%=product.getColor()%>">
									</div>
									<label class="col-md-2 control-label" for="count"><span style="color:red">* </span>数量</label>
									<div class="col-md-4">
										<input id="count" name="count" type="text" placeholder="0" class="form-control" value="<%=product.getCount()%>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="price"><span style="color:red">* </span>单价</label>
									<div class="col-md-4">
										<input id="price" name="price" type="text" placeholder="0.0" class="form-control" value="<%=product.getPrice()%>">
									</div>
									<label class="col-md-2 control-label" for="carton">件数</label>
									<div class="col-md-4">
										<input id="carton" name="carton" type="text" placeholder="0" class="form-control" value="<%=product.getCarton()%>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="cbm">立方数</label>
									<div class="col-md-4">
										<input id="cbm" name="cbm" type="text" placeholder="0.0" class="form-control" value="<%=product.getCbm()%>">
									</div>
									<label class="col-md-2 control-label" for="weight">重量（千克）</label>
									<div class="col-md-4">
										<input id="weight" name="weight" type="text" placeholder="0.0" class="form-control" value="<%=product.getWeight()%>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="commonts">备 注</label>
									<div class="col-md-10">
										<input id="commonts" name="commonts" type="text" placeholder="" class="form-control" value="<%=product.getCommonts()%>"></input>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-4">
										<button id="edit_product" type="button" class="btn btn-primary" onclick="edit_product()">提交</button>
									</div>
								</div>
							</fieldset>
						</form>
	...
	<script>
		$("#edit_product").click(function(){
			...
			var textdata = {"productId":productId,"model":model,"name":name,"color":color,"count":count,"price":price
					,"carton":carton,"commonts":commonts,"cbm":cbm,"weight":weight,"picture":picture};
